...
let NATSBroadcaster$1 = class NATSBroadcaster {
    constructor(options) {
...
var broadcaster = NATSBroadcaster$1;

// src/connector.js
const NATSBroadcaster = broadcaster;

let NATSConnector$1 = class NATSConnector {
    constructor(options) {
        this.options = options;
...
var connector = NATSConnector$1;

// src/index.js
const NATSConnector = connector;
